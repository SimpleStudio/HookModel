 ...
 */
public class HookModelAppSettingsAdvancedImsi
{
    public final String SaveFlag      = HookModelAppListWorker.GetAppSettingsString(46);
    public final String XmlFlag       = HookModelAppListWorker.GetAppSettingsString(47);
    public final String SummaryString = HookModelAppListWorker.GetAppSettingsString(48);
    public final String TitleString   = HookModelAppListWorker.GetAppSettingsString(49);
    ...
    public HookModelAppSettingsAdvancedImsi(HookModelAppSettingsWorker.PrefsFragment prefsFragment, String packageName, String parentKey)
    {
